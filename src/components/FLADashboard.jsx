...
//             );
//             // Use parent state for tracking collapse
//             const isTrackingOpen = !!openTracking[indent.id];
...
//                               {item.attachmentPath ? (
//                                 <a
//                                   href={`/api/indent/file/${item.attachmentPath}`}
//                                   target="_blank"
...
//                               )}
//                               {item.attachmentType && item.attachmentPath && (
//                                 <span
//                                   style={{
//                                     marginLeft: 8,
//                                     color: "#888",
...
//                                 rows={2}
//                                 sx={{ minWidth: 150 }}
//                                 disabled={selectedProducts[item.id] === true}
//                               />
//                             </TableCell>
//                           </TableRow>
//                         ))}
...
//                           ...prev,
//                           [indent.id]: !prev[indent.id],
//                         }))
//                       }
//                       sx={{ fontWeight: 600 }}
//                     >
//                       {isTrackingOpen ? "Hide Tracking" : "Show Tracking"}
//                     </Button>
//                   </Box>
//                   {/* Tracking Table (collapsible) */}
//                   {isTrackingOpen && <TrackingStepsTable indent={indent} />}
//                 </CardContent>
//               </Card>
//             );
//           })}
...
//         <DialogContent>
//           <DialogContentText>
//             Are you sure you want to review the selected products? Selected
//             items will be approved and forwarded to SLA, while items with
//             remarks will be rejected.
//           </DialogContentText>
//         </DialogContent>
//         <DialogActions>
