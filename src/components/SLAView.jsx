...
//                 <TableCell>
//                   <Chip
//                     label={item.productStatus === 'APPROVED_BY_FLA' ? 'Pending at SLA' : item.productStatus}
//                     color={item.productStatus === 'APPROVED_BY_FLA' ? 'warning' : item.productStatus?.includes('APPROVED') ? 'success' : item.productStatus?.includes('REJECTED') ? 'error' : 'default'}
//                     size="small"
//                   />
//                 </TableCell>
//                 <TableCell>
