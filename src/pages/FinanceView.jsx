...
import axios from "../api/api";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faCoins, faCheck, faTimes, faEye } from '@fortawesome/free-solid-svg-icons';
import {
  Card,
  CardContent,
  Typography,
          ...
          {indents.map((indent) => (
            <React.Fragment key={indent.id}>
              <TableRow hover>
                ...
                <TableCell sx={{ fontWeight: 600 }}>₹{indent.totalIndentCost}</TableCell>
                <TableCell>
                  <Chip
                  ...
                  {type === 'payment' && (
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (note) handlePaymentComplete(indent.id, note);
                      }}
                    >
                      Complete Payment
                    </Button>
